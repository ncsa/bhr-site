...
urlpatterns = [
    ...
    url(r'^api/block$', permission_required('bhr.add_block')(views.block.as_view())),
    url(r'^api/unblock_now$', permission_required('bhr.change_block')(views.unblock_now.as_view())),
    url(r'^api/stats$', views.stats),
    url(r'^api/source_stats$', views.source_stats),

    url(r'^api/mblock$', permission_required('bhr.add_block')(views.mblock.as_view())),
    url(r'^api/set_blocked_multi/(?P<ident>.+)$', permission_required('bhr.add_blockentry')(views.set_blocked_multi.as_view())),
    url(r'^api/set_unblocked_multi$', permission_required('bhr.change_blockentry')(views.set_unblocked_multi.as_view())),

    url(r'^api/queue/(?P<ident>.+)', permission_required('bhr.add_blockentry')(views.BlockQueue.as_view())),
    url(r'^api/unblock_queue/(?P<ident>.+)', permission_required('bhr.change_blockentry')(views.UnBlockQueue.as_view())),
    url(r'^api/query/(?P<cidr>.+)', login_required(views.BlockHistory.as_view())),
