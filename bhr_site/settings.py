"""
Django settings for bhr_site project.
...
SECRET_KEY = 'kcjc2^t3t2agpj&eaul!a0!(r)!b_t*e=3y=x(1s*$3ec^bz^2'
...
WSGI_APPLICATION = 'bhr_site.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '%(asctime)s [%(levelname)s] BHR %(message)s',
            'datefmt': '%Y-%m-%d %H:%M:%S'
        },
        'simple': {
